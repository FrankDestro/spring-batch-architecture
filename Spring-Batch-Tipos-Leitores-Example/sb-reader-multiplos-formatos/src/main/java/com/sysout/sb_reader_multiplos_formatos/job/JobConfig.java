package com.sysout.sb_reader_multiplos_formatos.job;
...
public class JobConfig {
    ...
    public Step stepArquivoMultiplosFormatos(
            @Qualifier("itemReaderArquivoMultiplosFormatos") FlatFileItemReader itemReaderArquivoMultiplosFormatos,
        ...
        return new StepBuilder("step", jobRepository)
                .chunk(1, txManager)
                .reader(itemReaderArquivoMultiplosFormatos)
